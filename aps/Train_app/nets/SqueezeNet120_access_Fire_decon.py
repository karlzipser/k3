...
class SqueezeNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.post_metadata_features = nn.Sequential(
            Fire(128, 16, 64, 64,'Fire1',self.A),
            nn.MaxPool2d(kernel_size=3, stride=2, ceil_mode=True),
            ...
            nn.ConvTranspose2d(in_channels=512,out_channels=512,kernel_size=3),
            nn.ReLU(),
    ...
    def forward(self, x):
        ...
        #self.A['post_metadata_features'] = nn.MaxUnpool2d(kernel_size=2,)
        ...
        return 0#self.A['final_output']


#def unit_test():
S = SqueezeNet()
a = S(Variable(torch.randn(64, 12, 94, 168)))
