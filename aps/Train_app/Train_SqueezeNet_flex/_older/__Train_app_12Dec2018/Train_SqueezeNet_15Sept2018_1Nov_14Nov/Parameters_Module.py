...
#from k3.Train_app.Train_SqueezeNet_15Sept2018_1Nov_14Nov.default_values import *
CODE_PATH__ = opjh('k3/Train_app')
VERSION_PATH = 'Train_SqueezeNet_15Sept2018_1Nov_14Nov'

#spd2s('Using',VERSION_PATH,'(make sure this is correct)')
time.sleep(3)

pythonpaths([opjh('k3'),opj(CODE_PATH__,VERSION_PATH),opj(CODE_PATH__,'nets')])
...
if True:
	import k3.Data_app.classify_data as classify_data
	
	
	if False:
		locations_to_classify = [opjD("Data/1_TB_Samsung_n1"),opjD("Data/2_TB_Samsung_n3/rosbags__preprocessed_data")]
	else:
