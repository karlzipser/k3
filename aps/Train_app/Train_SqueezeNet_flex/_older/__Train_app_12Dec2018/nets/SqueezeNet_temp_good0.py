...
class SqueezeNet(nn.Module):
    ...
    def __init__(self):
        ...
        final_conv = nn.Conv2d(128, self.N_STEPS * 2, kernel_size=3,stride=2)
    ...
    def forward(self, x, metadata):
        ...
        #print('pre_metadata_features_metadata: ')
        ...
        """
        self.A['final_output'] = self.final_output(self.A['pre_metadata_features'])
