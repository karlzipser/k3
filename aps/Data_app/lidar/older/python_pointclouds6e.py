...
while not timer.check():
    ...
    try:
        ...
        if calls_ > calls_prev:
            #print calls_,calls_prev

            freq_timer.freq()
            ########################
            #b = A['reflectivity'].reshape(width,height).copy()
            ########################
            ...
            if False:
                ...
                ########################
                #
                #b2 = A['t'].reshape(width,height).copy()
                #
                ########################

                #figure('reflectivity');plot(A['reflectivity'],'.');spause();raw_enter()
