...
import k3.VT_net2__1June2019.rectangles as rectangles
import k3.Array.Array
import std_msgs.msg
...
cg(sys_str)
os.system(sys_str)
cg("To start menu:\n\tpython k3/Menu_app/menu2.py path",project_path,"dic P")
##
#############################################################
#############################################################
...
Path_pts2D = k3.Array.Array.Array(P['num Array pts'],2)
...
Path_pts3D = k3.Array.Array.Array(P['num Array pts'],2)
height_in_pixels=94
width_in_pixels=168
...
Barrier_pts3D = k3.Array.Array.Array(P['num barrier pts'],2)
height_in_pixels=94
width_in_pixels=168
x_origin_in_pixels=0
y_origin_in_pixels=height_in_pixels
