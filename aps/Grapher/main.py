from k3.vis3 import *
import Menu.main
import k3.Grapher.grapher as grapher
import k3.Grapher.defaults as defaults
import k3.drafts.Markov.main as Markov_main
...
if HAVE_ROS:
    import k3.Grapher.subscribe as subscribe
    import std_msgs.msg
    S = subscribe.S
    Pub = {}
