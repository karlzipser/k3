...
#18April2019
roscore
python k3/VT_net2__5April2019_2__18April2019_for_speed/publish.py  pub_predictions 1 step 0
python k3/VT_net2__5April2019_2__18April2019_for_speed/publish.py  pub_predictions 9 step 0
python k3/VT_net2__5April2019_2__18April2019_for_speed/main.py # _['topic_suffix'] = ''
python k3/VT_net2__5April2019_2__18April2019_for_speed/main.py # _['topic_suffix'] = '_'
python k3/scripts/plot_topics.py topics headings_left_,headings_right_,headings_direct_ colors red,green,blue falloff 0.7
python k3/scripts/plot_topics.py topics headings_left,headings_right,headings_direct colors red,green,blue falloff 0.7
python k3/Menu_app/menu2.py path k3/Cars/a2Apr19/nodes dic P
python k3/Cars/a2Apr19/nodes/network_node.py desktop_mode 1
rosplay_menu.py
...
cg(sys_str)
os.system(sys_str)
cg("To start menu:\n\tpython k3/Menu_app/menu2.py path",project_path,"dic _")
...
if _['start menu automatically'] and using_linux():
    dic_name = "_"
    sys_str = d2n("gnome-terminal --geometry 40x30+100+200 -x python k3/Menu_app/menu2.py path ",project_path," dic ",dic_name)
    cr(sys_str)
    os.system(sys_str)
