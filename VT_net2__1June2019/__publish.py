##############################################################
####################### IMPORT ################################
## python k3/VT_net2__5April2019/main.py run tegra-ubuntu_29Oct18_13h28m05s
############
from k3.vis3 import *
...
Pub['motor'] = rospy.Publisher(bcs+'motor',std_msgs.msg.Int32,queue_size=1)
...
def get_data(_):
    ...
    return d_heading,sample_frequency,left_image,right_image,gyro_heading_x,encoder,motor,headings,encoders,motors
##
##############################################################
##############################################################
    ...
    try:
        while _['index'] < len(U['ts']) and not _['ABORT']:
            ...
            if rate_timer.check():
                ...
                d_heading,sample_frequency,left_image,right_image,gyro_heading_x,encoder,motor,Data['headings'],Data['encoders'],Data['motors'] = get_data(_)
