...
rospy.Subscriber(bair_car_str+'/FLEX', std_msgs.msg.Int32, callback=FLEX__callback)
	"""
	exec_str = s.replace('FLEX',f)
	exec(exec_str)

rospy.Subscriber(bair_car_str+'/steer', std_msgs.msg.Int32, callback=steer__callback)
rospy.Subscriber(bair_car_str+'/cmd/steer', std_msgs.msg.Int32, callback=cmd_steer__callback)
rospy.Subscriber(bair_car_str+'/cmd/motor', std_msgs.msg.Int32, callback=cmd_motor__callback)
rospy.Subscriber(bair_car_str+'/motor', std_msgs.msg.Int32, callback=motor__callback)
rospy.Subscriber(bair_car_str+'/button_number', std_msgs.msg.Int32, callback=button_number__callback)
rospy.Subscriber(bair_car_str+'/encoder', std_msgs.msg.Float32, callback=encoder__callback)
rospy.Subscriber(bair_car_str+'/acc', geometry_msgs.msg.Vector3, callback=acc__callback)
rospy.Subscriber(bair_car_str+'/gyro', geometry_msgs.msg.Vector3, callback=gyro__callback)
rospy.Subscriber(bair_car_str+'/gyro_heading', geometry_msgs.msg.Vector3, callback=gyro_heading__callback)
if P['USE_IMAGES']:
	if True:
