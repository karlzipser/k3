...
if 'NET_TYPE' not in Arguments:
    ...
    #clp("    e.g., python k3/drafts/Sq7/main.py --RESUME 1 --NET_TYPE ConDecon_test2 --NET_TYPE_SUFFIX 84x47\n\n")
    kprint(other.default_args.Default_Arguments,'NET_TYPE (required)')
    sys.exit()
