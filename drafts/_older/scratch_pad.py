...
for r in run_paths:
    if True:#not is_even(ctr):
        cy('ctr =',ctr)
        sys_str = d2s("python k3/Cars/n11Dec2018__predictions/nodes/network_node__make_predictions.py --graphics False --dst_folder /home/karlzipser/Desktop/Network_Predictions__temp --run_folder",r)
        cb(sys_str)
        os.system(sys_str)
    ctr += 1
