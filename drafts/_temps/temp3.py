...
python k3/Menu_app/menu2.py --path k3/Cars/j26June2019_rgb_v1/nodes --dic P
# 8,12,-1,8,10

#python k3/Cars/j26June2019__/nodes/network_node.py desktop_mode 1
python k3/Cars/j26June2019_rgb_v1/nodes/network_node.py desktop_mode 1
...
for w in selected_weightfiles:
    sys_str =  d2s(
        "python k3/Train_app/Sq120_ldr_output_4April2019/Main.py",
