...
START STOP USABLE_LENGTH SEGMENT_SECONDS
INSURE_CORRECT_NUMBER_OF_RUNS_ARE_OPEN OPEN_RUN_PATHS_INDEX OPEN_RUN_PATHS GET_RUN
BATCH_NUM FREE_RUN_TO_BATCH DATA OUTPUT OPEN
DATA_PATH ALL PATHS_OF_BATCHED SORTED_PATHS_OF_BATCHED RUNS NUM_PTS X_PREV Y_PREV CLICK FIG X Y
RIGHT_TIMESTAMP_INDEX_DIC
L_PATH O_PATH L O INDX TOPICS OPEN CLOSE READ LEFT RIGHT TOPICS
O_H5PY L_H5PY RUN_PATHS BATCH_FILES PATH
YES LOSS_TIMER IMAGE_DATA METADATA TARGET_DATA NAMES N_OUTPUTS LOSS_LIST_AVG ACTIVATIONS CTR PRINT_TIMER
DATA_PACKER LOSS OUTPUTS LOSS_LIST SAVE_NET_TIMER
NEXT
NETWORK NET
LIST_OF_IMAGES
LIST_OF_TARGET_FLOATS_OR_ARRAYS
LIST_OF_META_DATA_FLOATS_OR_ARRAYS
FREQUENCY_TIMER
LOSS_TIMER
...
deg rotate_around_marker get_data
