#clear
#echo "Start k3/bashrc..."

source ~/k3/misc/auto_aliases

#source ~/k3/Menu/complete.sh
#source ~/k3/Learn/complete.sh
...
alias ssd="echo 'Do shutdown manually!'"
...
alias pgacps='bash ~/k3/scripts/connect/pgacpssh.sh'
...
alias kr='~/k3/scripts/kill_ros.sh'
...
alias wait='python ~/k3/scripts/connect/wait_for_pull.py'

alias kill_screen='pkill screen'

alias empty_trash='rm -rf ~/.local/share/Trash/*'

alias Data='python ~/k3/Data_app/Main.py'
alias pGraph='python ~/k3/Grapher_app_for_preprocessed_data/Main.py'
alias rGraph='python ~/k3/Grapher_app_for_live_ros_data/Main.py'

alias m="~/k3/Menu/main.py"
alias n="~/k3/Menu/main.py --path k3/Menu/quick"
alias otn='k3/scripts/connect/open_tab_with_quick_menu.sh'

alias gacp="git add .;git commit -m 'gacp';git push origin master"
alias pgacp='cd ~/k3; git pull; gacp; cd'
alias pgp='cd ~/k3; git pull; cd'
alias Upgacp="pgacp; ssh -p 1022 karlzipser@169.229.219.140 'cd ~/k3; git pull; cd'"
...
if [ "$(whoami)" == "nvidia" ]
  then
    sudo bash ~/k3/scripts/gen/clean_pycs.sh ~/k3
    export PYTHONSTARTUP=~/k3/utils3.py
  else
    export PYTHONSTARTUP=~/k3/vis3.py
    bash ~/k3/scripts/gen/clean_pycs.sh ~/k3
fi
...
export PATH=~/k3/scripts/ros:$PATH
export PATH=~/k3/Commands:$PATH
export PATH=~/k3/misc:$PATH
...
alias menu='python ~/k3/Menu/main.py'


#python k3/scripts/connect/quick_print.py
