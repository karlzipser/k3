#######################################################
## python k3/scripts/ros/publish_preprocessed_data.py --step 0
############
from k3.vis3 import *
import std_msgs.msg
...
roscore
python k3/scripts/ros/publish_preprocessed_data.py  --pub_predictions 1 --step 0
python k3/scripts/ros/publish_preprocessed_data.py  --pub_predictions 9 --step 0
python k3/scripts/ros/publish_preprocessed_data.py  --pub_predictions 1 --step 0 --initial_index 10000
...
python k3/scripts/ros/plot_topics.py topics headings_left_,headings_right_,headings_direct_ colors red,green,blue falloff 0.7
python k3/scripts/ros/plot_topics.py topics headings_left,headings_right,headings_direct colors red,green,blue falloff 0.7
