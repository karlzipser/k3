...
e.g.,
    ...
    python k3/Menu_app/menu2.py path k3/Menu_app dic M
        ...
        try:
            ...
            if choice_number == 0:
                ...
                if name in to_expose_keys:
                    continue
                message = name+' value not changed!!!!!!! (need to mkdir __local__ ?)'
...
# python k3/Menu_app/menu.py path ~/k3/Cars/car_24July2018/nodes/__local__/arduino/ default 1 Topics arduino
