...
############################################
"""
python k3/Data_app/lidar/Offline_lidar_processing/Main.py autostart 1
"""
############################################
...
import k3.Data_app.lidar.Offline_lidar_processing.default_values as default_values
P = default_values.P
P['ABORT'] = False
try:
    if Arguments['autostart'] in [1,'y','Y','yes']:
        os.system(d2n("gnome-terminal -x python k3/Menu_app/menu2.py path ","k3/Data_app/lidar/Offline_lidar_processing"," dic P"))
    ...
    while P['ABORT'] == False:
        try:
            ...
            if parameter_file_load_timer.check():
                Topics = menu2.load_Topics("k3/Data_app/lidar/Offline_lidar_processing",first_load=False,customer='Main')
            if type(Topics) == dict:
