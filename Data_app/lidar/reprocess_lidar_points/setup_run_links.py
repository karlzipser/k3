...
from k3.Data_app.reprocess_lidar_points.runs_with_points import *
...
"""
python k3/drafts/setup_run_links.py --src /media/karlzipser/A3 --dst ~/Desktop/runs_with_points__links
Data src ~/Desktop/runs_with_points__links dst ~/Desktop/runs_with_points__h5py


python k3/drafts/setup_run_links.py --src /media/karlzipser/model_car_data_A2 --dst ~/Desktop/runs_with_points2__links
