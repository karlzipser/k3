...
#	pythonpaths(['k3','k3/Data_app'])
#
###############################
"""
To preprocess rosbags, e.g.:

python k3/Data_app/Main.py SRC '/media/karlzipser/rosbags/Mr_Yellow_29July2017/new' DST '/media/karlzipser/ExtraDrive2/bdd_car_data_July2017_LCR/h5py'

				To convert from pkl representation of data, e.g.:

				python k3/Data_app/Main.py 'DATA_SRC' '/media/karlzipser/ExtraDrive2/bdd_car_data_July2017_regular'  DST '/media/karlzipser/ExtraDrive2/bdd_car_data_July2017_regular/h5py'
