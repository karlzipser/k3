...
try:
	if len(sggo("k3/Grapher_app_for_preprocessed_data/__local__/Parameters_Module__local_.py")) > 0:
		q = 'n'#raw_input('load __local__ parameters? (y/n)')
		if q == 'y':
			from k3.Grapher_app_for_preprocessed_data.__local__.Parameters_Module__local_ import *
	else:
		q = 'no'
except:
...
if q != 'y':
	...
	P[X_PIXEL_SIZE] = 1500
	P[Y_PIXEL_SIZE] = 800#1100#2000#1100
	P[SCREEN_X] = 20
	P[SCREEN_Y] = 40
	P[MOUSE_MOVE_TIME] = 0
	P[MOUSE_X] = 0
